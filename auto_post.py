...
SUGGESTED_KEYWORDS = [
    # 🔥 [리빙/생활] 지갑이 가장 쉽게 열리는 가성비 꿀템
    "접이식 대용량 빨래바구니", "틈새 수납 슬라이딩 카트", "원터치 분리형 보온보냉병", 
    "규조토 풋매트 발매트", "초소형 미니 제습기", "가성비 암막 커튼",
    
    # 💻 [전자기기/데스크] 직장인·직구족 자극 아이템
    "초고속 충전 보조배터리 20000", "접이식 블루투스 키보드", "듀얼 모니터 거치대 암",
    "노트북 쿨링 패드 거치대", "가성비 가로형 멀티탭 6구", "노이즈캔슬링 가성비 헤드폰",
    
    # 🚗 [차량용품] 운전자들이 상시 검색하는 소모품/소품
    "차량용 헤드레스트 거치대", "자동차 가죽시트 틈새쿠션", "차량용 고성능 에어컨필터",
    "대용량 카 인테리어 방향제", "차량용 미니 무선 청소기", "트렁크 깔끔 정리함",
    
    # 🍳 [주방용품] 자취생 및 주부 타겟 즉시 구매 품목
    "스텐 배수구망 싱크대", "야채 탈수기 샐러드볼", "양면 실리콘 도마",
    "가성비 에어프라이어 종이호일", "초간편 마늘 다지기 가위", "스텐 진공 밀폐용기",
    
    # 🏃 [헬스/웰니스] 건강 및 자기관리 유행 템
    "휴대용 미니 마사지건", "가성비 인바디 체중계", "무소음 스태퍼 홈트",
    "스포츠 무릎 보호대 스트랩", "전동 단백질 쉐이커 텀블러", "바른자세 교정 밴드",
    
    # ✨ [뷰티/케어] 형의 뷰티/웰니스 노하우 확장용 베이스
    "모공 청소 삭신기 필링기", "가성비 시카 수분크림", "트러블 케어 패치 대용량"
]
